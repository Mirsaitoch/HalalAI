...
%\input{my_folder/task}				 % Задание (отключено)
...
\input{my_folder/introduction}	    	 % Глава 1: Введение
\input{my_folder/chapter1}	         	 % Глава 2: Теоретическая часть
\input{my_folder/chapter2}	         	 % Глава 3: Практическая реализация
\input{my_folder/chapter3}           	 % Глава 4: Тестирование
...
\input{my_folder/appendix1}			     % Приложение А: Код LLM-Service

% Сброс inputenc после lstlisting чтобы избежать коррупции TOC (lstlisting переопределяет активные UTF-8 символы)
\inputencoding{utf8}
\input{my_folder/appendix2}			 	 % Приложение Б: Код Backend

\inputencoding{utf8}
\input{my_folder/appendix3}			 	 % Приложение В: Код iOS-приложения
