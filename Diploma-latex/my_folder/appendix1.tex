\chapter{Код LLM-Service}\label{app:llm}
\setcounter{tocdepth}{-1}\setcounter{secnumdepth}{-1}

\codefile{src/halal\_rag/\_\_init\_\_.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]

"""HalalAI RAG Service"""
\end{lstlisting}

\codefile{src/halal\_rag/api/\_\_init\_\_.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]

"""API module"""
\end{lstlisting}

\codefile{src/halal\_rag/api/dto/\_\_init\_\_.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/halal\_rag/api/dto/api\_info\_response.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/halal\_rag/api/dto/root\_response.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/halal\_rag/api/dto/health\_response.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/halal\_rag/api/dto/chat\_request.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/halal\_rag/api/dto/chat\_response.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/halal\_rag/api/interfaces.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/halal\_rag/api/services.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/halal\_rag/api/dependencies.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/halal\_rag/api/main.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/halal\_rag/rag/\_\_init\_\_.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]

"""RAG module"""
\end{lstlisting}

\codefile{src/halal\_rag/rag/interfaces.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/halal\_rag/rag/embeddings.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/halal\_rag/rag/vector\_store.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/halal\_rag/rag/retriever.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/halal\_rag/llm/\_\_init\_\_.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]

"""LLM module"""
\end{lstlisting}

\codefile{src/halal\_rag/llm/interfaces.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/halal\_rag/llm/open\_router.py}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
