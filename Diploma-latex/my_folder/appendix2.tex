\chapter{Код Backend}\label{app:backend}
\setcounter{tocdepth}{-1}\setcounter{secnumdepth}{-1}

\codefile{src/main/java/com/halalai/backend/HalalAiBackendApplication.java}
...
\codefile{src/main/java/com/halalai/backend/config/DataLoader.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/config/RestTemplateConfig.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/config/SecurityConfig.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/controller/AuthController.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/controller/ChatController.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/controller/VerseController.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/dto/AuthResponse.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/dto/ChatRequest.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/dto/ChatResponse.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/dto/ConfigResponse.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/dto/ErrorResponse.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/dto/LoginRequest.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/dto/RefreshTokenRequest.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/dto/RegisterRequest.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/dto/VerseResponse.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/exception/GlobalExceptionHandler.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/model/User.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/model/Verse.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/repository/UserRepository.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/repository/VerseRepository.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/security/JwtAuthenticationFilter.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/security/JwtTokenProvider.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/service/AuthService.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/service/ConfigService.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/service/IAuthService.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/service/IConfigService.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/service/ILLMService.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/service/IVerseService.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/service/LLMService.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/service/UserDetailsServiceImpl.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{src/main/java/com/halalai/backend/service/VerseService.java}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
