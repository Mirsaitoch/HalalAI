\chapter{Код iOS-приложения}\label{app:ios}
\setcounter{tocdepth}{-1}\setcounter{secnumdepth}{-1}

\codefile{HalalAI/App/HalalAIApp.swift}
...
\codefile{HalalAI/App/RootView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/App/ScreenFactory.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Core/Components/ErrorMessageView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Core/Components/ErrorView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Core/Components/GuestAuthPromptView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Core/Components/GuestBannerView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Core/Components/ImageTextComponent.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Core/Extensions/HapticFeedback+Modes.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Core/Extensions/View+AdditionalPadding.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Core/Extensions/View+HideKeyboard.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Core/Location/LocationService.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Core/Network/APIConfiguration.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Core/Network/APIRequest.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Core/Network/Endpoint.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Core/Network/NetworkClient.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Core/Network/NetworkError.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Auth/Models/AuthModels.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Auth/Service/AuthManager.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Auth/Service/AuthRequests.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Auth/Service/AuthService.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Auth/UI/AuthFlowView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Auth/UI/AuthTextField.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Auth/UI/Login/LoginView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Auth/UI/Login/LoginViewModel.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Auth/UI/Register/RegisterView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Auth/UI/Register/RegisterViewModel.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Chat/Models/ChatModels.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Chat/Service/ChatService.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
final class ChatServiceImpl: ChatService {
    ...
    func loadModels() async {
        do {
            ...
            guard response.statusCode == 200 else {
                print("   Ошибка загрузки моделей: \(String(data: data, encoding: .utf8) ?? "nil")")
                return
            }
    ...
    func sendMessage(_ text: String) {
        ...
        if isSending, let last = lastSendAt, Date.now.timeIntervalSince(last) > 15 {
            isSending = false
            print("   sendMessage: предыдущий запрос завис >15с, сбрасываем isSending")
        }
        guard !isSending else {
            print("   sendMessage: блокируем отправку, предыдущий запрос еще обрабатывается")
            return
        }
...
\codefile{HalalAI/Features/Chat/Service/ChatSettingsStore.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Chat/UI/ChatUtils.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Chat/UI/ChatView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Chat/UI/ChatViewModel.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Chat/UI/EmptyChatView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Chat/UI/InputBar.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Chat/UI/MessageBubble.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/HalalMap/Models/HalalPlaceModels.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/HalalMap/Service/HalalPlacesService.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/HalalMap/UI/HalalMapView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/HalalMap/UI/HalalMapViewModel.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Home/Models/Verse.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Home/Service/VerseService.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Home/UI/HomeView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Home/UI/HomeViewModel.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Home/UI/VerseView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Prayer/Models/PrayerModels.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Prayer/Service/PrayerNotificationService.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Prayer/Service/PrayerSettingsStore.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Prayer/Service/PrayerTimeService.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Prayer/UI/PrayerNotificationSettingsView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
struct PrayerNotificationSettingsView: View {
    ...
    private var calculationSection: some View {
        Section(header: Text("Метод расчета")) {
            ...
            Text("Выберите метод расчета в соответствии с вашим регионом или предпочтениями.")
                .font(.footnote)
                .foregroundStyle(.secondary)
        }
    }
...
\codefile{HalalAI/Features/Prayer/UI/PrayerTimesCardView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Prayer/UI/PrayerTimesCardViewModel.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Quran/Models/QuranModels.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Quran/Service/QuranStorageService.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
final class QuranStorageServiceImpl: QuranStorageService {
    ...
    /// Парсит одну строку CSV с учетом кавычек (поля в кавычках могут содержать запятые).
...
\codefile{HalalAI/Features/Quran/UI/QuranListView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Quran/UI/QuranListViewModel.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Quran/UI/SuraReaderView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Quran/UI/SuraReaderViewModel.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Scanner/Models/IngredientModels.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Scanner/Service/IngredientCSVParser.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Scanner/Service/IngredientMatcher.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Scanner/Service/IngredientService.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Scanner/UI/CameraView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Scanner/UI/IngredientResultsView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Scanner/UI/ScannerView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Scanner/UI/ScannerViewModel.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Features/Settings/UI/RemoteModelSettingsSection.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
/// Секция настроек удаленной модели: выбор модели, max_tokens, temperature, RAG.
...
\codefile{HalalAI/Features/Settings/UI/SettingsView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
struct SettingsView: View {
    ...
    private var apiKeySection: some View {
        ...
        return Section(header: Text("API ключ провайдера")) {
            ...
            Text("Если указать API ключ (например, OpenAI или совместимый), ответы будут генерироваться через удаленную модель. Без ключа применяется локальная модель HalalAI.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
        }
...
\codefile{HalalAI/Features/Settings/UI/SettingsViewModel.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Navigation/AuthCoordinator.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Navigation/ChatCoordinator.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Navigation/Coordinator.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Navigation/HomeCoordinator.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Navigation/RouterView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Navigation/SettingsCoordinator.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Navigation/TabBar/TabBarItem.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
...
\codefile{HalalAI/Navigation/TabBar/TabBarView.swift}
\begin{lstlisting}[basicstyle=\tiny\ttfamily,breaklines=true]
