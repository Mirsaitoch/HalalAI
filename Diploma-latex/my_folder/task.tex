...
\begin{enumerate}[1.]
	...
	\item Исходные данные по работе: \uline{анализ существующих исламских цифровых сервисов; тексты Корана для векторной базы знаний RAG; требования ГОСТ к оформлению ВКР.}% не забываем точку!
