...
\newcommand{\thesisOPTitle}{Прикладная информатика}% наименование образовательной программы
%%
%%
\newcommand{\institute}{
