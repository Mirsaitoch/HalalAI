...
%%
%%
\newcommand{\keywordsRu}{iOS-приложение, RAG, LLM, искусственный интеллект, халяль} % ВВЕДИТЕ ключевые слова по-русски
%%
%%
\newcommand{\keywordsEn}{iOS application, RAG, LLM, artificial intelligence, halal} % ВВЕДИТЕ ключевые слова по-английски
%%
%%
