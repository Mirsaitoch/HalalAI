...
DEFAULT_MAX_NEW_TOKENS = int(os.getenv("LLM_DEFAULT_MAX_TOKENS", "1024"))
MAX_NEW_TOKENS = int(os.getenv("LLM_MAX_TOKENS", "2048"))
MIN_NEW_TOKENS = 16
...
REMOTE_LLM_MODEL = os.getenv("REMOTE_LLM_MODEL", "tngtech/deepseek-r1t2-chimera:free")
